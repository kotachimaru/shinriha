...
const ECG_QUESTIONS = [
  ...
  {
    id: 613, chapter: 6, chapterName: '心電図・不整脈', qNum: 13,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['洞性頻脈', '心房細動', '心房粗動', '心室頻拍', '上室性頻拍'],
    answer: 2,
    explanation: '【正解：②心房細動（AF）】P波が消失してf波（基線の細かい揺れ）が出現し、RR間隔が不規則なのが特徴。心房内に複数の異所性興奮が無秩序に生じる。心房粗動はF波（のこぎり歯状）が規則的で心室レートも一定。',
    ecgType: 'af'
  },
  {
    id: 614, chapter: 6, chapterName: '心電図・不整脈', qNum: 14,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['心房細動', '心室細動', '心室頻拍', '洞性徐脈', '3度房室ブロック'],
    answer: 4,
    explanation: '【正解：④洞性徐脈】P波が規則的に出現しQRS波形が正常、RR間隔が広い（心拍数<60bpm）。心臓リハビリ中に運動強度が適切か確認が必要。β遮断薬や迷走神経優位でも起こる。心拍数40bpm未満の場合は運動中止を検討する。',
    ecgType: 'brady'
  },
  {
    id: 615, chapter: 6, chapterName: '心電図・不整脈', qNum: 15,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['心房細動', '2度房室ブロック（ウェンケバッハ型）', '洞停止', '3度（完全）房室ブロック', '心室頻拍'],
    answer: 4,
    explanation: '【正解：④3度（完全）房室ブロック】P波と無関係に心室補充収縮が出現する。洞結節からの刺激が全く心室に伝わらないため、心室は独自に30〜40bpmで収縮する。ペースメーカー植込みの適応となる。',
    ecgType: 'chb'
  },
  {
    id: 616, chapter: 6, chapterName: '心電図・不整脈', qNum: 16,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['心房細動', '洞性頻脈', '心室細動', '心房粗動', '上室性頻拍（PSVT）'],
    answer: 4,
    explanation: '【正解：④心房粗動（AFL）】のこぎり歯状のF波（心房レート約300bpm）が規則的に出現し、2:1〜4:1で心室に伝導する。本例は4:1伝導（心室レート約75bpm）。AFと異なりRR間隔は一定。',
    ecgType: 'afl'
  },
  {
    id: 617, chapter: 6, chapterName: '心電図・不整脈', qNum: 17,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['心房細動', '心室頻拍', '心室細動', '多源性心室期外収縮', 'トルサード・ド・ポワント'],
    answer: 3,
    explanation: '【正解：③心室細動（VF）】心室筋が不規則に痙攣し有効な拍出がゼロになる致死性不整脈。波形は不規則な大小の波が連続する。即時除細動と心肺蘇生が必要。AEDの使用適応となる代表的な不整脈。',
    ecgType: 'vf'
  },
  {
    id: 618, chapter: 6, chapterName: '心電図・不整脈', qNum: 18,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['上室性頻拍（PSVT）', '心房粗動2:1伝導', '心室頻拍（VT）', '洞性頻脈', '心室細動'],
    answer: 3,
    explanation: '【正解：③心室頻拍（VT）】幅広いQRS（>0.12秒）が連続し心拍数100〜250bpm。心室由来の異常興奮が連続して発生する。30秒以上続く持続性VTは即除細動の適応。洞性頻脈や上室性頻拍はQRS幅が正常（狭い）。',
    ecgType: 'vt'
  },
  {
    id: 619, chapter: 6, chapterName: '心電図・不整脈', qNum: 19,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['心房期外収縮（PAC）', '単源性心室期外収縮（PVC）二段脈', '多源性心室期外収縮', '2度房室ブロック', '心室頻拍'],
    answer: 2,
    explanation: '【正解：②単源性PVC二段脈（bigeminy）】正常拍1拍ごとにP波のない幅広QRSが出現する。同一起源のため異常QRSの形は一定（単源性）。代償性休止期を伴う。心房期外収縮はP波を伴い幅の狭いQRSが出現する。',
    ecgType: 'pvc'
  },
  {
    id: 620, chapter: 6, chapterName: '心電図・不整脈', qNum: 20,
    question: '下の心電図の不整脈名として正しいのはどれか。',
    options: ['単源性心室期外収縮', '多源性心室期外収縮', '心室頻拍', '心房粗動', '心房細動'],
    answer: 2,
    explanation: '【正解：②多源性心室期外収縮】複数の心室異所性起源から出るため、異常QRSの形が2種類以上混在する。単源性PVCより危険度が高く、心室頻拍・心室細動への移行リスクがある。運動を即中止し医師へ報告する。',
    ecgType: 'mpvc'
  },
];
